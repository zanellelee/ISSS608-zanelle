...
##### 3.2.1. Proportion of functional and non-functional water points
...
Step 4: Writing a percentile mapping function
...
Step 2: Creating get.var function
...
-   returns:
    ...
    1.  v: vector with values (without a column name)
...
Step 3: Test newly created function
